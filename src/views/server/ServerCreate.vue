<template>
     ...
     <el-form :model="form" ref="formRef" :rules="formRules" label-width="100px">
        ...
        <el-form-item label="主机名称：" prop="hostname">
          ...
          <el-tag class="ml-2" type="warning"><el-icon><InfoFilled/></el-icon>必须与实际主机名一致</el-tag>
        </el-form-item>
        ...
        <el-form-item label="SSH凭据：" prop="credential">
          ...
          <el-col :span="3" :offset="1">
            <el-button type="primary" plain @click="this.$router.push('/credential')">新建</el-button>
            <el-button type="primary" plain @click="createDiglogVisible = true">新建2</el-button>
          </el-col>
        </el-form-item>
    ...
    <CredentialCreate v-model:visible="createDiglogVisible"></CredentialCreate>
</template>

<script>
    import CredentialCreate from "@/views/credential/CredentialCreate";
