...
<!--            multiple 多选属性-->
          <el-select class="m-2"  v-model="form.server_group" @click="getServerGroup"   placeholder="请选择">
    ...
    export default {
        ...
        data() {
            return {
                ...
                idc: '',
                serverGroup: '',
                excelTemplateDown: 'http://127.0.0.1:8001/api/cmdb/excel_create_host',
                fileList: [],
            }
        },
        methods: {
