<template>
   <el-card>
       ...
       <el-table
               ...
               style="width: 100%"
       >
        <el-table-column prop="name" label="机房名称" v-if="showColumn.name"/>
...
<IdcEdit v-model:visible="editDiglogVisible"  :row="currentRow"></IdcEdit>
<IdcCreate v-model:visible="createDiglogVisible"></IdcCreate>
</template>
